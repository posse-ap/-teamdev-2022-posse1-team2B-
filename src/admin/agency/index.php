...
<head>
  ...
  <link rel="stylesheet" href="./admin/agency/agency.css">
</head>
<body>
  <?php include(dirname(__FILE__) . "/../admin/agency/agency_header.php");?>
  ...
  <?php include(dirname(__FILE__) . "/../admin/agency/agency_footer.php");?>
