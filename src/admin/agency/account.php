  ...
  <div>
    ...
    <form method="POST" action="../../thanks.php">
      ...
      <div>
        ...
        <p><?php echo $_POST["inquiry_email_address"];?></p>
      </div>
      <div>
        <label>ログイン用メールアドレス</label>
        <p><?php echo $_POST["login_email_address"];?></p>
      </div>
      <div>
      ...
      <button type="submit" name="completion_of_registration">登録完了</button>
      <input type="hidden" name="company_name" value="<?php echo $_POST['company_name']; ?>">
      <input type="hidden" name="inquiry_email_address" value="<?php echo $_POST['inquiry_email_address']; ?>">
      <input type="hidden" name="login_email_address" value="<?php echo $_POST['login_email_address']; ?>">
    ...
    <div>
      <form action="" method="POST">
          ...
          <div>
              ...
              <input type="email" name="inquiry_email_address" id="inquiryEmailAddress" value="<?php if(isset($_POST["inquiry_email_address"])){echo $_POST["inquiry_email_address"];}?>" required>
          </div>
          <div>
              <label for="loginMailAddress">ログイン用メールアドレス<span>必須</span></label>
              <input type="email" name="login_email_address" id="loginEmailAddress" value="<?php if(isset($_POST["login_email_address"])){echo $_POST["login_email_address"];}?>" required>
          </div>
          <div>
